...
namespace Magfinalproject.Controllers
{
    ...
    public class staffsController : Controller
    {
        ...
        {
            var staffs = db.staffs.Include(s => s.colleges) ;
        ...
        {
            ViewBag.collegesid = new SelectList(db.colleges, "id", "name");
        ...
        public ActionResult Create(staff staff, HttpPostedFileBase upload)
        {
            ...
            ViewBag.collegesid = new SelectList(db.colleges, "id", "name", staff.collegesid);
