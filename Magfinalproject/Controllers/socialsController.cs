...
namespace Magfinalproject.Controllers
{
    ...
    public class socialsController : Controller
    {
        ...
        public JsonResult Check_clsname(String social_name, int? ID)
        {
            var validatename = db.Categories.FirstOrDefault(x => x.classname.ToString() == social_name.ToString() && x.ID != ID);
